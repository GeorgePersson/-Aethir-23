...
namespace BeautifyEffect {
    ...
    public partial class Beautify : MonoBehaviour {
        ...
        const string BEAUTIFY_BUILD_HINT = "BeautifyBuildHint104b2";
            ...
            if (allowExtraEffects) {
                ...
                if (_depthOfField) {
                    ...
                    if (cam != null && cam.cameraType != CameraType.SceneView) {
                        ...
                        if ((_depthOfFieldTransparencySupport || _depthOfFieldExclusionLayerMask != 0) && !bMat.IsKeywordEnabled(ShaderParams.SKW_DEPTH_OF_FIELD_TRANSPARENT)) {
